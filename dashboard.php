                            ...
                            <div class="col-xl-6 col-md-12">
                                <div class="card latest-update-card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <ul class="list-unstyled card-option">
                                                <li><i class="fa-solid fa-wrench open-card-option"></i>
                                                </li>
                                                <li><i class="fa-solid fa-window-maximize full-card"></i></li>
                                                <li><i class="fa-solid fa-minus minimize-card"></i></li>
                                                <li><i class="fa-solid fa-refresh reload-card"></i></li>
                                                <li><i class="fa-solid fa-trash close-card"></i></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card social-card bg-simple-c-pink">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <i
                                                    class="fa-brands fa-x-twitter f-34 text-c-pink social-icon"></i>
                                            </div>
                                            <div class="col">
                                                <h6 class="m-b-0">X</h6>
                                                <p>231.2w downloads</p>
